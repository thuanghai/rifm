...
from resources.signal_element import SignalElement

class TestL1SignalElement():
    # document '_id' in mongodb during the test
    __test_id = 'test_signal_element-' + str(get_timestamp())
    ...
    def test_get(self, client):
        ...
        chkresponse = client.get(
            url_for('api.signal_element', id = find_id)
        )
    ...
    def test_put(self, client):
        ...
        chkresponse = client.put(
            url_for('api.signal_element', id = update_id),
    ...
    def test_delete(self, client):
        ...
        chkresponse = client.delete(
            url_for('api.signal_element', id = delete_id)
        )
        assert chkresponse.status_code == 200
